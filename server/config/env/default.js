...
module.exports = {
    ...
    successMsgGet: ' details fetched successfully',
    successMsgAdd : ' added successfully',
    successMsgUpdate: ' updated successfully',
    successMsgDelete: ' deleted successfully',
    errorMsgGet: 'could not fetch ',
    errorMsgAdd: 'could not add ',
    errorMsgUpdate: 'could not update',
    errorMsgDelete: 'could not delete',
    invalidLogin : 'username or password incorrect',
    successfulLogin : 'user logged in successfully',
    sessionAlive: 'user session is alive',
    sessionNotAlive: 'session expired',
    successLogout: 'user logged out successfully',
    errorChangePassword: 'could not save new password',
